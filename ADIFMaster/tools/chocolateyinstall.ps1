...
$url        = 'https://www.dxshell.com/downloads/ADIFMasterSetup.zip' # download url, HTTPS preferred
...
$packageArgs = @{
  ...
  softwareName  = 'ADIF Master*' #part or all of the Display Name as you see it in Programs and Features. It should be enough to be unique

  # Checksums are now required as of 0.10.0.
  # To determine checksums, you can get that from the original site if provided. 
  # You can also use checksum.exe (choco install checksum) and use it 
  # e.g. checksum -t sha256 -f path\to\file
  checksum      = '992F37D255234E5FC39879ED446A763826E408E3B4DCA672DE75AA6E939B098C'
